...
public class Main {
    ...
    private final static int MAX_NUMBER_OF_WEEKS = 52;
    private final static int MAX_NUMBER_OF_DAYS = 7;
    private final static int MAX_NUMBER_OF_HOURS = 24;
    public static void exercise4() {
        System.out.println("\nExercise 4:");

        for (int week = 0; week < MAX_NUMBER_OF_WEEKS; week++) {
            for (int day = 0; day < MAX_NUMBER_OF_DAYS; day++) {
                for (int hour = 0; hour < MAX_NUMBER_OF_HOURS; hour++) {
